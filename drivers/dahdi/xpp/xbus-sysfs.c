...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 11, 0) || RHEL_VERSION_GE(9, 8)
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 11, 0) || (defined(RHEL_RELEASE_CODE) && RHEL_VERSION_GE(9, 8)
